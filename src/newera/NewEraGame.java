...
import newera.gfx.GdxCanvas;
import newera.gfx.Inputs;
import newera.gfx.KeyMap;
import newera.gfx.Screen;
import newera.gfx.Terminal;
import newera.screens.MenuScreen;
import newera.sfx.Sounds;
import newera.ui.Theme;
import newera.ui.UserInterfaceManager;
import newera.util.Command;
import newera.util.CommonCommands;
import newera.util.Config;
import newera.util.Cons;
import newera.util.Console;
import newera.util.StateMachine;
 ...
 *
 */
public class NewEraGame implements ApplicationListener {
	 ...
	 * 
	 */
	public NewEraGame(Config config) throws Exception {
		this.config = config;
...
//		});
		...
		console.addCommand(new Command("mouse_sensitivity") {
			...
			@Override
			public void execute(Console console, String... args) {
				newera.gfx.Cursor cursor = uiManager.getCursor();
				if(args.length==0) {
	...
	public void create() {		
		...
		newera.gfx.Cursor cursor = this.uiManager.getCursor();
