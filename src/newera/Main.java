...
import newera.util.Logger;
import newera.util.PrintStreamLogger;
...
public class Main {
	...
	public static void main(String[] args) throws Exception {
		...
		try {
			...
			cfg.title = "newera " + NewEraGame.getVersion();
			cfg.forceExit = true;
			cfg.resizable = false;
			cfg.useGL30 = true;			
			...
			new LwjglApplication(new NewEraGame(config), cfg);			
	...
	public static void logSystemSpecs(Logger console) {
		...
		console.println("");
		console.println("newera: " + NewEraGame.getVersion());
