...
import newera.map.MapTile.SurfaceType;
import newera.math.OBB;
...
public abstract interface Map extends Renderable {
	 ...
	 */
	public abstract void init(SceneDef info);
	 ...
	 * @return
	 */
	public abstract MapTile getTile( int layer, int x, int y );
	public abstract MapTile getDestructableTile(int x, int y );
	 ...
	 * @return
	 */
	public abstract MapTile getCollidableTile(int x, int y );
	
	
	
	/**
	 * Get a {@link ImageTile} from world coordinates
	 * @param layer
	 * @param x - x in world coordinate space
	 * @param y - y in world coordinate space
	 * @return
	 */
	public abstract MapTile getWorldTile( int layer, int x, int y);
	 ...
	 * @return
	 */
	public abstract MapTile getWorldCollidableTile(int x, int y);
	 ...
	 */
	public abstract List<MapTile> getTilesInCircle(int layer, int centerX, int centerY, int radius, List<MapTile> tiles);
	 ...
	 * @return a list of tiles within the circle
	 */
	public abstract List<MapTile> getTilesInCircle(int centerX, int centerY, int radius, List<MapTile> tiles);
	 ...
	 */
	public abstract List<MapTile> getTilesInRect(Rectangle bounds, List<MapTile> tiles);
	 ...
	 * @return  a list of tiles within the {@link Rectangle}
	 */
	public abstract List<MapTile> getTilesInRect(int layer, Rectangle bounds, List<MapTile> tiles);
	 ...
	 * @param mask
	 */
	public abstract void setMask(List<MapTile> tiles, int mask);
	 ...
	 */
	public abstract List<MapTile> getRemovedTiles();
