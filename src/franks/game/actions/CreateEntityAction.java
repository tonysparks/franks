...
import franks.game.entity.EntityData.CreateEntityActionData;
...
public class CreateEntityAction extends Action {
    ...
    private CreateEntityActionData data;
    
    /**
     * @param data
     * @param entity
     */
    public CreateEntityAction(CreateEntityActionData data, Entity entity) {
        super(ActionType.Create, -1, entity);
