...
public class Cursor {
    ...
    private Vector2f cursorPos, centerPos;
    ...
    public Vector2f getCenterPos() {
        this.centerPos.set(this.cursorPos);
        this.centerPos.x -= 0f;//cursorImg.getRegionWidth()/2f;
        this.centerPos.y += 0f;
        //this.centerPos.y += cursorImg.getRegionHeight()/2f;
