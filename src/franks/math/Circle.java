...
public class Circle {
    ...
    public static boolean circleIntersectsLine(Circle circle, Vector2f a, Vector2f b) {
        ...
        // translate to origin
        Vector2f.Vector2fSubtract(a, circle.origin, ca);
        Vector2f.Vector2fSubtract(b, circle.origin, cb);

        Vector2f d = new Vector2f();
        Vector2f.Vector2fSubtract(cb, ca, d);

        float dr = Vector2f.Vector2fLengthSq(d);
        float det = Vector2f.Vector2fDet(ca, cb);
